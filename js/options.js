...
function injectOptionsMenu() {
  ...
  // 6. Marquer la langue et le thème actifs au démarrage
...
function buildPanelHTML() {
  ...
  const langButtons = LANGS.map(l => `
    <button class="lang-opt" data-lang="${l.code}" title="${l.name}">
  ...
  return `
    <div class="options-header">
      ...
      <button class="options-close" aria-label="Fermer">×</button>
    </div>
    ...
    <div class="opt-section">
      <div class="opt-section-title">
        ...
        <span data-key="options-lang">Langue</span>
      </div>
...
function openOptions() {
  document.getElementById('optionsPanel').classList.add('is-open');
  document.getElementById('optionsBackdrop').classList.add('is-visible');
  document.getElementById('optionsBtn').classList.add('is-open');
}

function closeOptions() {
  document.getElementById('optionsPanel').classList.remove('is-open');
  document.getElementById('optionsBackdrop').classList.remove('is-visible');
  document.getElementById('optionsBtn').classList.remove('is-open');
}


/* ────────────────────────────────────────────────────────────
   markActiveLang / markActiveTheme
   Met à jour visuellement le bouton actif.
   ──────────────────────────────────────────────────────────── */
